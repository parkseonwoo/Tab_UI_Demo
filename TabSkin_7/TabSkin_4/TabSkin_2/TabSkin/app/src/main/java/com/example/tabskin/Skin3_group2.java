...
public class Skin3_group2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.skin3_group2);
        ...
        ALL.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Skin3_group2.this, Skin3.class);
        ...
        group1.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view) {
                Intent myintent = new Intent(Skin3_group2.this, Skin3_group1.class);
        ...
        group2.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent intent = new Intent(Skin3_group2.this, Skin3_group2.class);
                        startActivity(intent);
                    }
                });
        ...
        group3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Skin3_group2.this, Skin3_group3.class);
                startActivity(intent);
            }
        });
        ...
        group4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Skin3_group2.this, Skin3_group4.class);
                startActivity(intent);
            }
        });
        ...
        mgroup1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Mgroup1 == 1) {
                    ...
                    AlertDialog.Builder ad = new AlertDialog.Builder(Skin3_group2.this);
