...
public class adgroup3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.adgroup3);
        ...
        ALL.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(adgroup3.this, Skin2.class);
        ...
        group1.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view) {
                Intent myintent = new Intent(adgroup3.this, adgroup1.class);
        ...
        group2.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent intent = new Intent(adgroup3.this, adgroup2.class);
                        startActivity(intent);
                    }
                });
        ...
        group3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(adgroup3.this, adgroup3.class);
                startActivity(intent);
            }
        });
        ...
        group4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(adgroup3.this, adgroup4.class);
                startActivity(intent);
            }
        });
        ...
        mgroup1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Mgroup1 == 1) {
                    ...
                    AlertDialog.Builder ad = new AlertDialog.Builder(adgroup3.this);
