...
public class Skin4_group1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.skin4_group1);
        ...
        ALL.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Skin4_group1.this, Skin4.class);
        ...
        group1.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view) {
                Intent myintent = new Intent(Skin4_group1.this, Skin4_group1.class);
        ...
        group2.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent intent = new Intent(Skin4_group1.this, Skin4_group2.class);
                        startActivity(intent);
                    }
                });
        ...
        group3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Skin4_group1.this, Skin4_group3.class);
                startActivity(intent);
            }
        });
        ...
        group4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Skin4_group1.this, Skin4_group4.class);
                startActivity(intent);
            }
        });
        ...
        mgroup1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Mgroup1 == 1) {
                    ...
                    AlertDialog.Builder ad = new AlertDialog.Builder(Skin4_group1.this);
