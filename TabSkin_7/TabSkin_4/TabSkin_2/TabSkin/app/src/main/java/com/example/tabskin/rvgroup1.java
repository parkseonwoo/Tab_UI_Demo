...
public class rvgroup1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.rvgroup1);
        ...
        ALL.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(rvgroup1.this, Skin1.class);
        ...
        group1.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view) {
                Intent myintent = new Intent(rvgroup1.this, rvgroup1.class);
        ...
        group2.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent intent = new Intent(rvgroup1.this, rvgroup2.class);
                        startActivity(intent);
                    }
                });
        ...
        group3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(rvgroup1.this, rvgroup3.class);
                startActivity(intent);
            }
        });
        ...
        group4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(rvgroup1.this, rvgroup4.class);
                startActivity(intent);
            }
        });
        ...
        mgroup1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Mgroup1 == 1) {
                    ...
                    AlertDialog.Builder ad = new AlertDialog.Builder(rvgroup1.this);
